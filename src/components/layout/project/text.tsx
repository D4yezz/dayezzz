...
export default function TextProject({ project }: { project: Project }) {
  ...
  return (
    <div
      ref={ref}
      className="lg:w-[40%] w-full lg:h-screen lg:sticky lg:mt-0 lg:py-26 py-8 lg:top-0 flex items-center lg:order-3 order-1 font-instrument-sans overflow-hidden"
    >
